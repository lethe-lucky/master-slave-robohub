...
#ifndef ROBO_INTERFACES__SRV__DETAIL__READ_DATA__FUNCTIONS_H_
#define ROBO_INTERFACES__SRV__DETAIL__READ_DATA__FUNCTIONS_H_
...
/// Initialize srv/ReadData message.
/**
...
/// Create srv/ReadData message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_interfaces__srv__ReadData_Request__init().
...
/// Destroy srv/ReadData message.
/**
 * It calls
 * robo_interfaces__srv__ReadData_Request__fini()
...
/// Check for srv/ReadData message equality.
/**
...
/// Initialize array of srv/ReadData messages.
/**
...
/// Finalize array of srv/ReadData messages.
/**
 * It calls
 * robo_interfaces__srv__ReadData_Request__fini()
...
/// Create array of srv/ReadData messages.
/**
 * It allocates the memory for the array and calls
 * robo_interfaces__srv__ReadData_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ReadData messages.
/**
 * It calls
 * robo_interfaces__srv__ReadData_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ReadData message array equality.
/**
...
/// Copy an array of srv/ReadData messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * robo_interfaces__srv__ReadData_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_interfaces
...
/**
 * It calls
 * robo_interfaces__srv__ReadData_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_interfaces
...
/**
 * It allocates the memory for the array and calls
 * robo_interfaces__srv__ReadData_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_robo_interfaces
...
/**
 * It calls
 * robo_interfaces__srv__ReadData_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROBO_INTERFACES__SRV__DETAIL__READ_DATA__FUNCTIONS_H_
