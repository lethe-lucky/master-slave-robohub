...
static const _SetAngle_type_support_symbol_names_t _SetAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robo_interfaces, msg, SetAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robo_interfaces, msg, SetAngle)),
  }
};
...
{
  return &::robo_interfaces::msg::rosidl_typesupport_cpp::SetAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robo_interfaces, msg, SetAngle)() {
  return get_message_type_support_handle<robo_interfaces::msg::SetAngle>();
}
